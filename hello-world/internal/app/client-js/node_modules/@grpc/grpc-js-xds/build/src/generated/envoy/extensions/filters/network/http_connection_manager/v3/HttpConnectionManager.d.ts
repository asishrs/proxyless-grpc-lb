...
export declare enum _envoy_extensions_filters_network_http_connection_manager_v3_HttpConnectionManager_CodecType {
    /**
 ...
 * header.
 */
export declare enum _envoy_extensions_filters_network_http_connection_manager_v3_HttpConnectionManager_ForwardClientCertDetails {
    /**
...
export declare enum _envoy_extensions_filters_network_http_connection_manager_v3_HttpConnectionManager_Tracing_OperationName {
    /**
...
export declare enum _envoy_extensions_filters_network_http_connection_manager_v3_HttpConnectionManager_ServerHeaderTransformation {
    /**
