...
export declare enum _envoy_config_filter_network_http_connection_manager_v2_HttpConnectionManager_CodecType {
    /**
 ...
 * header.
 */
export declare enum _envoy_config_filter_network_http_connection_manager_v2_HttpConnectionManager_ForwardClientCertDetails {
    /**
...
export declare enum _envoy_config_filter_network_http_connection_manager_v2_HttpConnectionManager_Tracing_OperationName {
    /**
...
export declare enum _envoy_config_filter_network_http_connection_manager_v2_HttpConnectionManager_ServerHeaderTransformation {
    /**
